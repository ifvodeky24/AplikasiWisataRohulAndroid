...
import com.example.aplikasiwisatarohul.databinding.ActivityDetailPenginapanBinding
...
class DetailPenginapanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvNamaPenginapan.text = penginapan.nama_penginapan
        binding.tvAlamat.text = penginapan.alamat
        binding.tvKelurahan.text = penginapan.kelurahan
        binding.tvKecamatan.text = penginapan.kecamatan
        binding.tvInformasi.text = penginapan.informasi
        binding.tvTanggalUpdate.text = penginapan.updatedAt

        Glide.with(this)
            .load(ApiConfig.penginapan_images + penginapan.foto)
            .into(binding.ivPenginapan)
